...
export function InboxIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 20 20" aria-hidden>
      <path d="M6.02 3.25h7.96c.87 0 1.65.54 1.95 1.36l1.52 4.06c.06.16.09.33.09.5v5.08a2.125 2.125 0 0 1-2.125 2.125H4.585A2.125 2.125 0 0 1 2.46 14.25V9.17c0-.17.03-.34.09-.5l1.52-4.06a2.08 2.08 0 0 1 1.95-1.36m0 1.25a.83.83 0 0 0-.78.545L3.86 8.62h2.53c.62 0 1.125.504 1.125 1.125v.13c0 .621.504 1.125 1.125 1.125h2.92c.621 0 1.125-.504 1.125-1.125v-.13c0-.621.504-1.125 1.125-1.125h2.53l-1.38-3.575a.83.83 0 0 0-.78-.545zm10.27 5.37h-2.4c-.06 1.27-1.11 2.28-2.39 2.28H8.5a2.395 2.395 0 0 1-2.39-2.28h-2.4v4.38c0 .483.392.875.875.875h10.83a.875.875 0 0 0 .875-.875z" />
    </svg>
  )
}
