  ...
  return (
    ...
    <div className="w-full overflow-clip [overflow-clip-margin:1rem]" role="img" aria-label={leg}>
      ...
      <div
        ...
        data-progress={at}
      >
        <div className="absolute inset-0 origin-left rounded-full bg-primary transition-transform duration-320 ease-settle will-change-transform transform-[scaleX(var(--scale))]" />
        <div className="pointer-events-none absolute inset-0 transition-transform duration-320 ease-settle will-change-transform transform-[translate3d(var(--at),0,0)]">
          <Mark
